...
class ScheduleApp {
    ...
    renderCalendar() {
        try {
            ...
            // Generate calendar days (exclude Saturday - day 7)
    ...
    openDayModal(date) {
        ...
        if (this.isMobile) {
            ...
            console.log('Opening modal on mobile - menuToggle element:', menuToggle);
            console.log('Opening modal on mobile - header element:', header);
            
            if (menuToggle) {
                console.log('Hiding menu toggle button on mobile');
            ...
            if (header) {
                console.log('Hiding header on mobile');
            ...
            console.log('Desktop mode - not hiding header/menu');
        }
    ...
    closeModal() {
        ...
        if (this.isMobile) {
            ...
            console.log('Closing modal on mobile - menuToggle element:', menuToggle);
            console.log('Closing modal on mobile - header element:', header);
            
            if (menuToggle) {
                console.log('Showing menu toggle button on mobile');
                ...
                console.warn('menuToggle element not found on close!');
            }
            
            if (header) {
                console.log('Showing header on mobile');
                header.style.transition = 'all 0.5s cubic-bezier(0.68, -0.55, 0.265, 1.55)';
                header.style.opacity = '1';
                header.style.transform = 'translateY(0)';
                header.style.pointerEvents = 'auto';
            } else {
                console.warn('header element not found on close!');
            }
        } else {
            console.log('Desktop mode - not restoring header/menu');
        }
    }
